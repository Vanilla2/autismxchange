  ...
  schema: {
    collections: [
      ...
      },
      {
        ...
        label: "Homepage (ro)",
        name: "homepage__ro_",
        path: "exampleSite/content/romanian",
        frontmatterFormat: "yaml",
        ui: {
          allowedActions: {
            create: false,
      ...
      },
      {
        ...
        label: "Blog Page (ro)",
        name: "blog_page__ro_",
        path: "exampleSite/content/romanian/blog",
        frontmatterFormat: "yaml",
        ui: {
          allowedActions: {
            create: false,
      ...
      },
      {
        ...
        label: "Contact (ro)",
        name: "contact__ro_",
        path: "exampleSite/content/romanian/contact",
        frontmatterFormat: "yaml",
        ui: {
          allowedActions: {
            create: false,
      ...
      },
      {
        ...
        label: "Pricing (ro)",
        name: "pricing__ro_",
        path: "exampleSite/content/romanian/pricing",
        frontmatterFormat: "yaml",
        ui: {
          allowedActions: {
            create: false,
      ...
      },
      {
        ...
        label: "FAQ (ro)",
        name: "faq__ro_",
        path: "exampleSite/content/romanian/faq",
        frontmatterFormat: "yaml",
        ui: {
          allowedActions: {
            create: false,
